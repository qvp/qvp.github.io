    ...
    portfolio: [
        {
            ...
            title: 'Atom Security',
            link: null,
            short_desc: 'Система управления логами, отслеживания угроз и атак на сервера.',
            term: null,
            desc: 'Приложение позволяет просматривать и управлять логами от различных систем. Отслеживать угрозы и атаки на эти системы.',
            my_work: 'Разработана система поиска логов и доставки их в реальном времени. Матрица атак ATT&CK MITRE',
            tags: [1,2,3,34,33,25,4],
            api: ['ATT&CK MITRE'],
            parsing: [],
            previews: []
        },
