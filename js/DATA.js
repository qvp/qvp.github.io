    ...
    portfolio: [
        {
            ...
            my_work: 'Мной сделана система поиска логов и доставки их в реальном времени на ClickHouse и Channels. А так же работал над другими компонентами системы. Разработана aiochorm - асинхронная версия clickhouse_orm, данная библиотека скоро будет доведена до open-source состояния и выложена на github.',
            tags: [1,2,34,8,33],
            api: ['ATT&CK MITRE'],
            parsing: [],
